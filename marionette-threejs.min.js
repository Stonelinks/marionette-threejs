...
},initialize:function(){this.once("show",function(){this.setupRenderer(),this.setupCamera(),this.setupScene(),this.setupPointerEvents(),this.setupTransformControl(),this.setupOrbitControl(),this.collection.fetch();var a=this;window.addEventListener("resize",function(){a.onWindowResize()},!1),a.startWebGLRendering(),a.render()})}}),b.TransformControlMode=d.ItemView.extend({templateHelpers:function(){return{transformControlSpace:this.transformControl&&g(this.transformControl.get("space"))}},events:{"click #translate-mode":function(){this.transformControl.set("mode","translate")},"click #rotate-mode":function(){this.transformControl.set("mode","rotate")},"click #scale-mode":function(){this.transformControl.set("mode","scale")},"click #toggle-space":function(){var a="local"==this.transformControl.get("space")?"world":"local";this.transformControl.set("space",a),this.render()}},transformControl:void 0,initialize:function(a){this.transformControl=a.transformControl}})}return b});